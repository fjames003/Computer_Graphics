...
(function () {
    ...
    // A few circles.
    Primitives.circleTrig(renderingContext, 105, 315, 100, [128, 128, 128]);
    Primitives.circleDDA(renderingContext, 310, 315, 100, [255, 0, 255]);
    // Primitives.circleBres1(renderingContext, 515, 315, 100);
    // Primitives.circleBres2(renderingContext, 720, 315, 100);
    Primitives.circleBres3(renderingContext, 925, 315, 100, [255,0,0], [0, 255, 255]);
